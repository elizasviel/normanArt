...
export const CustomTransformControls: ForwardRefComponent<
...
>(
  (
    ...
    React.useLayoutEffect(
      () => void (onChangeRef.current = onChange),
      [onChange]
    );
    React.useLayoutEffect(
      () => void (onMouseDownRef.current = onMouseDown),
      [onMouseDown]
    );
    React.useLayoutEffect(
      () => void (onMouseUpRef.current = onMouseUp),
      [onMouseUp]
    );
    React.useLayoutEffect(
      () => void (onObjectChangeRef.current = onObjectChange),
      [onObjectChange]
    );
